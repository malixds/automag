        ...
        <div
            ...
            <div
                ...
                <div class="relative space-y-8 pt-12 pb-4 p-8">
                    <img src="{{ asset('images/jerrycan_10821446.png') }}" class="w-12" width="512" height="512"
            ...
            <div
                class="group relative hover:bg-orange-400 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10 transition duration-300">
                <div class="relative space-y-8 pt-12 pb-4 p-8">
                    <img src="{{ asset('images/filter_3348214.png') }}" class="w-12" width="512" height="512"
                        alt="burger illustration">
            ...
            <div
                ...
                <div class="relative space-y-8 pt-12 pb-4 p-8">
                    <img src="{{ asset('images/new-car_5044540.png') }}" class="w-12" width="512" height="512"
                        alt="burger illustration">
