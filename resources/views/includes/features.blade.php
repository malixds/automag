        ...
        <div
            ...
            <div
                ...
                <div class="relative space-y-8 pt-12 pb-4 p-8">
                    ...
                    <a href="{{ route('oil') }}" class="h-24 mt-0 flex items-center justify-between group-hover:text-white">
            ...
            <div
                ...
                <div class="relative space-y-8 pt-12 pb-4 p-8">
                    ...
                    <a href="{{ route('filters') }}" class="h-24 mt-0 flex items-center justify-between group-hover:text-white">
                        <span class="text-sm">Подробнее</span>
                        <i class="fa-solid fa-arrow-right text-white"></i>
                    </a>
                </div>
            ...
            <div
                ...
                <div class="relative space-y-8 pt-12 pb-4 p-8">
                    ...
                    <a href="{{ route('accum') }}" class="h-24 mt-0 flex items-center justify-between group-hover:text-white">
                        <span class="text-sm">Подробнее</span>
                        <i class="fa-solid fa-arrow-right text-white"></i>
                    </a>
                </div>
            ...
            <div
                ...
                <div class="relative space-y-8 pt-12 pb-4 p-8">
                    ...
                    <a href="{{ route('chemistry') }}" class="h-24 mt-0 flex items-center justify-between group-hover:text-white">
                        <span class="text-sm">Подробнее</span>
                        <i class="fa-solid fa-arrow-right text-white"></i>
                    </a>
                </div>
